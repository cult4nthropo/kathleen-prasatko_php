...
<html lang="de"  id="up">
	...
	<div class="wrapper">
		...
		<main>
			...
			<h2 class="visually-hidden">Über mich</h2>
			<h3> Wer ich bin</h3>
				<p>Studiert habe ich in Tübingen im Magister mit zwei Hauptfächern: Ethnologie und Ostslavische Philologie. <br/>
			...
			<h2 class="visually-hidden">Infoboxen zur Weiterleitung auf andere Seiten der Website</h2>
				<article class="infobox">
				<a href="cv.php"><i class="fas fa-book"></i></a>
					<h4>Lebenslauf</h4>
					<p>Die Stationen meines Lebenslaufes. <br/>
					Von Schule über Studium und Weiterbildung bis zu Interessen.
					</p>
					<p><a href="cv.php">Lebenslauf</a></p>
				</article>
				<article class="infobox">
				<a href="code.php"><i class="far fa-star"></i></a>
					<h4>Meine Projekte</h4>
					<p>Beispielprojekte, die ich selbst entwickelt habe und Verlinkung zu meinem GitHub-Account 
					</p>
					<p><a href="code.php">Projekte</a></p>
				</article>
				<article class="infobox">
					<a href="contact.php"><i class="fas fa-at"></i></a>
					<h4>Kontakt</h4>
					<p>Für Fragen und Anregungen <br/>
					Nutzen Sie bitte das <a href="contact.php">die Möglichkeiten auf der Kontaktseite</a></p>
				</article>
			</section>
		</main>
		</div>
